...
The package registers OPPi defaults, docked UI, `/effort`, `/permissions`, `/review`, `/init`, `todo_write`, `ask_user`, feedback intake, `image_gen`, `render_mermaid`, themes, terminal setup, usage footer, Hoppi memory hooks, and compaction helpers.
